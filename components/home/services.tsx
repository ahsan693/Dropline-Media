...
import paidMediaImage from "./servicessectionimages/Vimeo card.png";
								...
								<div className={styles.mediaRail}>
									<div
										className={`${styles.mediaDrift} ${
											card.motion === "left" ? styles.driftLeft : styles.driftRight
										}`}
									>
										<Image
											src={card.image}
											...
											loading={card.title === "Paid Media" || card.title === "Content Creation" ? undefined : "lazy"}
											priority={card.title === "Paid Media" || card.title === "Content Creation"}
										/>
									</div>
								</div>
							</article>
